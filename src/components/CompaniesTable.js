...
const CompaniesTable = () => {
    ...
    const [newCompany, setNewCompany] = useState({ companyName: '', companyTitle: '', logo: '', backgroundImage: '' });
    ...
    const handleAddCompany = async () => {
        ...
        setNewCompany({ companyName: '', companyTitle: '', logo: '', backgroundImage: '' });
    };
    ...
    const handleUpdateCompany = async (id, updates) => {
        ...
        if (newValues) {
            const [companyName, companyTitle, logo, backgroundImage] = newValues.split(',');
            await updateCompany(id, { companyName, companyTitle, logo, backgroundImage });
            const updatedCompanies = companies.map(company => {
                if (company.id === id) {
                    return { ...company, companyName, companyTitle, logo, backgroundImage };
                }
